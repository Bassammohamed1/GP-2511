    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromForm] UserDTO data)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new AppUser() { UserName = data.UserName, Email = data.Email, PasswordHash = data.Password, Image = $"{Request.Scheme}://{Request.Host}/files/uploads/images/{fileName}" };
